...
- [x] **#7** Cap cAdvisor CPU/RAM + increase scrape interval to 30s | commit 256e11a | 2026-04-07
...
### Group 2 — Resource limits (informed by monitoring data)
...
### Group 5 — Performance / reliability
...
### Group 6 — Observability (heavy lift)
- [ ] **#20** Add Loki log aggregation | LOE: High | ROI: High | Impact: High

### Group 7 — Maintenance / cleanup
...
## Done
- [x] **#3** Add swap space | commit 2fb79ae | 2026-04-07
